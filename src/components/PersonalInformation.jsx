...
import { fetchProfile, postProfile } from "../api/profile";
...
function PersonalInformation() {
  ...
  useEffect(() => {
    async function getProfile() {
      try {
        const call = await fetchProfile(cookies.token);
        console.log(call.data.data);
        const prof = call.data.data;
  ...
  const updateProfile = async () => {
    ...
    try {
      const call = await postProfile(cookies.token, updatableData);
      console.log(call);
      ...
      try {
        ...
        message.success("Profile Data updated for " + prof.full_name);
      } catch (error) {
        console.error(error);
      }
    } catch (error) {
      ...
      <div className="my-6 flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-3 justify-between mt-4">
          <button
            ...
            className="rounded-xl px-4 py-2 cursor-pointer font-semibold font-work text-white bg-primary border border-primary flex flex-row items-center justify-center gap-2"
          >
            <svg
              width="15"
              height="16"
